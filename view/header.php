...
<body>
  <nav class="navbar navbar-expand-lg bloodBankHeader fixed-top">
    <a class="navbar-brand" href="/">betWins</a>
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{base_url()}/restaurant-dashboard">Dashboard</a>
        </li>
        <li class="nav-item">
          <a class="nav-link restoLogout" href="javascript:void(0);">Logout</a>
        </li>
